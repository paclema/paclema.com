...
The IoT-PostBox firmware is built using the Arduino-ESP8266 framework and PlatformIO. Depending the ESP8266 module used (ESP-12F or ESP-07S), you will need to select the appropriate board environment. Further instructions and documentation can be found in the [Firmware page]({{< relref  "firmware.md" >}}). 
